    ...
    return (
        <div className="shop-list">
            ...
            <div className="section-navigation">
                ...
                <button onClick={handleNextSection} disabled={currentSection === totalSections - 1}>
                    Next
                </button>
            </div>
        </div>
...
},
{
  ...
  return (
    <section className="dashboard section" style={{paddingTop:0}}>
      <DashboardBanner/>
      <div className="row">
        <div className="col-lg-9"><h1 style={{fontWeight:600, display:"flex" ,marginTop:"60px" ,marginBottom:"40px",justifyContent:"center",color:"rgb(117, 117, 119)"}}>My Services</h1>
          <div className="row">
            ...
            <div className="col-12">
              ...
              <h1 style={{fontWeight:600, display:"flex" ,marginTop:"60px" ,marginBottom:"40px",justifyContent:"center",color:"rgb(117, 117, 119)"}}>My Plans</h1>
              <RecentSales />
        ...
        <div className="col-lg-3" style={{background:"rgb(248, 245, 192) ", paddingTop:"10px"}}>
          <h1 style={{fontWeight:600, display:"flex" ,marginTop:"60px" ,marginBottom:"60px",justifyContent:"center",color:"rgb(117, 117, 119)"}}>Calender</h1>
          <Calender />
        </div>
      </div>
    </section>
